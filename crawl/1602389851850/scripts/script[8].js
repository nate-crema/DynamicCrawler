...
Base URL: https://www.youtube.com/s/desktop/f748deac/jsbin/www-tampering.vflset/www-tampering.js || Script sequence: [8]
...
function c(h,k){this.a=h;t(this,"description",{configurable:!0,writable:!0,value:k})}
...
function e(g,d){var f=d&&typeof d;"object"==f||"function"==f?k.has(d)?f=k.get(d):(f=""+ ++m,k.set(d,f)):f="p_"+d;var l=g.f[f];if(l&&y(g.f,f))for(var r=0;r<l.length;r++){var v=l[r];if(d!==d&&v.key!==v.key||d===v.key)return{id:f,list:l,index:r,b:v}}return{id:f,list:l,index:-1,b:void 0}}
